 ...
 * @author Cay Horstmann, Modified by Stephen Gilbert
 * @version CS 272 Spring 2016
 */
public class AllShapesDemo extends JPanel
{
    // used by the inner classes below
    ...
    public AllShapesDemo()
    {
        ...
        // Add a nice 18 point font and some space
     ...
     * define it.
     */
    class ShapeComponent extends JPanel
    {
...
//        private static final int DEFAULT_HEIGHT = 200;
        ...
        public void paintComponent(Graphics g)
        {
            ...
            // Lets thicken up the line a little
            g2.setStroke(new BasicStroke(2f));
            // And make it a nice color
    ...
    class ArcMaker extends ShapeMaker
    {
        ...
        public Shape makeShape(Point2D[] p)
        {
            ...
            double skewedStartAngle = Math.toDegrees(Math.atan2(
                    -(p[2].getY() - centerY) * width, (p[2].getX() - centerX)
                            * height));
            double skewedEndAngle = Math.toDegrees(Math.atan2(
    ...
    private static String appName = "Shapes Demo";
    ...
    public static void main(String[] args)
    {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                AllShapesDemo app = new AllShapesDemo();
